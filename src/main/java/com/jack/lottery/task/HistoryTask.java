...
public class HistoryTask {
    ...
    public static void ssq() throws Exception {
        ...
        for (Element e : as) {
            ...
            String prizeDetail = JSONObject.toJSONString(detailList).replace("\"addNum\":0,", "");
    ...
    //抓所有补充
    public static void ssq1() throws Exception {
    ...
    //抓取补充
    public static void dlt1() throws Exception{
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/lottery", "root", "root");
    ...
    //抓补充
    public static void sd1() throws Exception{
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/lottery", "root", "root");
    ...
    //抓补充
    public static void pls1() throws Exception{
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/lottery", "root", "root");
    ...
    //抓补充
    public static void plw1() throws Exception{
        Class.forName("com.mysql.jdbc.Driver");
        Connection connection = DriverManager.getConnection("jdbc:mysql://127.0.0.1:3306/lottery", "root", "root");
